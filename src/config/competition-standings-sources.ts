...
export const DEFAULT_COMPETITION_STANDINGS_SOURCES: CompetitionStandingsSource[] = [
  ...
  { competitionId: "38", competitionName: "Pro League", countryName: "Belgium", zerozeroUrl: "https://www.zerozero.pt/competicao/liga-belga", mode: "regular_plus_playoffs", status: "needs_phase_rules", enabled: true, defaultPhaseNotes: ["Competição com fase regular e múltiplos playoffs finais."], phaseRules: belgianPlayoffRules },
  ...
  { competitionId: "211", competitionName: "Niké Liga", countryName: "Slovakia", zerozeroUrl: "https://www.zerozero.pt/competicao/liga-eslovaca", mode: "regular_plus_playoffs", status: "needs_phase_rules", enabled: true, competitionAliases: ["Nike Liga"], defaultPhaseNotes: ["Competição com fase regular e grupos finais."], phaseRules: [...regularSeasonSplitRules, ...championshipGroupRules, ...relegationRoundRules()] },
