...
test("filterFixturesByCompetition keeps only allowed competition ids", () => {
  const fixtures = [
    { sourceEventId: "1", competitionId: "17" },
    { sourceEventId: "2", competitionId: "9999" },
    { sourceEventId: "3", competitionId: null },
    { sourceEventId: "4", competitionId: "238" },
  ];

  assert.deepEqual(filterFixturesByCompetition(fixtures, new Set(["17", "238"])), [
    { sourceEventId: "1", competitionId: "17" },
    { sourceEventId: "4", competitionId: "238" },
  ]);
});
