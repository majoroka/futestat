...
export const DEFAULT_COMPETITION_STANDINGS_SOURCES: CompetitionStandingsSource[] = [
  ...
  { competitionId: "46", competitionName: "Super League", countryName: "Switzerland", zerozeroUrl: "https://www.zerozero.pt/competicao/liga-suica", mode: "regular_plus_playoffs", status: "needs_phase_rules", enabled: true },
  ...
  { competitionId: "325", competitionName: "Brasileirao Serie A", countryName: "Brazil", zerozeroUrl: "https://www.zerozero.pt/competicao/brasileirao-serie-a", mode: "single_table", status: "ready", enabled: true },
  { competitionId: "155", competitionName: "Liga Profesional", countryName: "Argentina", zerozeroUrl: "https://www.zerozero.pt/competicao/i-divisao-argentina", mode: "regular_plus_playoffs", status: "needs_validation", enabled: true },
];
