import { generateTeamInventoryReport } from "../infrastructure/manual/team-inventory-report.js";
...
async function main(): Promise<void> {
  ...
  const result = await generateTeamInventoryReport(process.cwd(), options);
